...
addItemBtn.addEventListener("click", function () {
  ...
  addBtn.addEventListener("click", function () {
    ...
    var itemName = document.querySelector(".addItemName").value;
    var itemPrice = document.querySelector(".addPrice").value;
    var imageInput = document.querySelector("#categoryPhotoInput").getAttribute("src");
    var itemIngredient = document.querySelector(".addIngredient").value;
    ...
    '<div class="menu-card col-2 col-lg-2 col-sm-2 col-md-2 me-4 my-3" data-category="pizza">'+
            '<div class="menu-item container-fluid shadow-lg bg-body">'+
              '<img src="'+imageInput+'" class="align-items-center w-2 img-fluid rounded mx-auto d-block mb-4 ms-4" />'+
            '</div>'+
